...
export function Keyboard(props) {
    ...
    return (
        ...
        // keyboard typing into the page. preventDefault on mousedown suppresses
        // the default focus move that would blur the canvas again straight
        // after. Focus is taken on pointerdown so a touch gets it at the same
        // moment as a click (the compatibility mousedown arrives on release).
