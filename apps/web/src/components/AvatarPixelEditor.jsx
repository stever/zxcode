...
export default function AvatarPixelEditor({ identifier, onSave, onCancel }) {
    ...
    const fillGrid = () => {
        setGrid(Array(8).fill(null).map(() => Array(8).fill(selectedColor)));
    };
            ...
            <div className="flex gap-3">
                ...
                <div className="flex-grow-1">
                    <div className="flex align-items-center justify-content-between mb-2">
                        <h4 className="m-0">Draw Your Avatar</h4>
                    ...
                    >
                        <div style={{
                            ...
                            gap: showGrid ? '1px' : '0',
                            backgroundColor: showGrid ? '#3a3a3a' : 'transparent',
                        }}>
                ...
                <div style={{ width: '200px' }}>
                    ...
                    <div className="flex gap-1 mb-2">
                        <Button
                            icon="pi pi-pencil"
                            className={`p-button-sm ${tool === 'paint' ? '' : 'p-button-outlined'}`}
                        ...
                        {SPECTRUM_COLORS.map((color, index) => (
                            <div
                                ...
                                style={{
                                    ...
                                    border: selectedColor === index && tool === 'paint'
                                        ? '3px solid white'
                                        : '1px solid #3a3a3a',
                                    borderRadius: '4px',
                                    cursor: 'pointer',
