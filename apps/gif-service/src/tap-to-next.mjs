// Vendored copy of packages/emulator/src/zxgo/tapToNext.js (canonical) —
// this service installs standalone (no workspace hoisting in its Docker
// image), so cross-package imports are not available. Keep in sync.
