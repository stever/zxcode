...
// wasm distro-card prep (cmd/zxplay_go) seeds the identical file onto an
// ingested official card image.
const DefaultNextConfigINI = `; ZX Spectrum Next config.ini (seeded by zxplay_go on ROM download)
;
