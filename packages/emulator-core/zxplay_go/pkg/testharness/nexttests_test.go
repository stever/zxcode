...
//
// Where the program exposes a behaviour zxplay_go knowingly lacks, the test
...
// test zxplay_go must get right today: NOP blocks accept ~one interrupt per
...
// documented core-version deviations (zxplay_go reports core 3.2.3 and is
