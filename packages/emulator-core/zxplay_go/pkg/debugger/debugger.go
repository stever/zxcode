...
// ring controller (cmd/zxplay_go provides one over the emulator-owned
...
// Typically called from cmd/zxplay_go with the same *History that
...
// 128K-class machines. Mirrors cmd/zxplay_go/debugger.go's lookup so
...
// without the cmd/zxplay_go cpuState wrapper.
