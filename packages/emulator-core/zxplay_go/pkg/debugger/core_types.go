...
// telnet debug commands in cmd/zxplay_go, and the wasm build. Keep this
...
// show alongside CPU registers. The cmd/zxplay_go GUI wires this in
...
// cmd/zxplay_go implements it over the emulator-owned snapshot ring, so
