...
sys.path.insert(0, "/home/steve/Git/github.com/stever/zxcode/packages/emulator-core/zxplay_go/hwdebug")
import dzrp
...
link.request(dzrp.CMD_INIT, bytes([2, 0, 0]) + b"zxplay_go-probe\x00")   # once only
T0 = time.monotonic()
